...
description: Turkish news classification pipeline with AA API ingestion, Kafka, fine-tuned BERT, REST/SSE API, and dashboard.
date: 2026-04-30
...
# aa-news-encoder [Turkish news classification pipeline with AA API ingestion, Kafka, fine-tuned BERT, REST/SSE API, and dashboard.]
